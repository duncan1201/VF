 ...
 * **/
public class TBlastxService extends AbstractBlastService{

	@Override
	protected void validatePutCommand(BlastParams params) {
		if(params.getProgram() == null || params.getProgram() != BlastParams.PROGRAM.tblastx){
			throw new IllegalArgumentException("Program must be tblastx");
		}
		if(params.getBlastPrograms() == null || params.getBlastPrograms() != BlastParams.BLAST_PROGRAMS.tblastx){
			throw new IllegalArgumentException("Blast Program must be tblastx");
		}
	...
	public static void main(String[] args){
		...
		TBlastxService service = new TBlastxService();
		service.setParams(BlastParamsFactory.createInstance(PROGRAM.tblastx));
	...
	static {
		ALLOWED_BLAST_PROGRAMS.add(BLAST_PROGRAMS.tblastx);
