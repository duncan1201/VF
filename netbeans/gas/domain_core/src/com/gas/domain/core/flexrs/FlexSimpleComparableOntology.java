 ...
 * @since 1.5
 */
public class FlexSimpleComparableOntology extends AbstractChangeable implements ComparableOntology {
     ...
     */
    public FlexSimpleComparableOntology(String name) {
        if (name == null) {
    ...
    protected FlexSimpleComparableOntology() {
    }

    /**
     * {@inheritDoc} Ontologies are compared only by name.
     */
    ...
    /**
     * {@inheritDoc} Ontologies are equal if their names are equal.
     */
    ...
    /**
     * {@inheritDoc} If the term has to be created, it is added with the
     * description "auto-generated by biojavax".
     */
    ...
    public Term createTerm(String name, String description, Object[] synonyms) throws AlreadyExistsException, ChangeVetoException, IllegalArgumentException {
        ...
        ComparableTerm ct = new FlexSimpleComparableTerm(this, name, synonyms);
    ...
    /**
     * {@inheritDoc} This particular implementation merely copies the term into
     * this ontology, and returns a pointer to the copied term. Thus the term
    ...
    public Term importTerm(Term t, String localName) throws ChangeVetoException, IllegalArgumentException {
        ...
        ComparableTerm ct = new FlexSimpleComparableTerm(this, localName, t.getSynonyms());
    ...
    /**
     * {@inheritDoc} If you call this method with plain Terms instead of
     * ComparableTerms, it will import them into the local ontology first. This
     * is done BEFORE the check to see if the triple already exists, as
     * obviously it can't check until it has the right terms to check with. So
     * you may find the terms get imported but the triple does not. Moral of the
     * story: use ComparableTerm objects!
     *
     * @see ComparableTerm
     */
    public Triple createTriple(Term subject, Term object, Term predicate, String name, String description) throws AlreadyExistsException, ChangeVetoException {
        ...
        ComparableTriple ct = new FlexSimpleComparableTriple(this, (ComparableTerm) subject, (ComparableTerm) object, (ComparableTerm) predicate);
    ...
    /**
     * {@inheritDoc} If you call this method with a plain Term instead of a
     * ComparableTerm, it may not match any of the terms in the ontology as they
     * are all stored as ComparableTerms. So, use ComparableTerm objects! This
     * method also removes all triples that the term is involved in.
     *
     * @see ComparableTerm
     */
    ...
    /**
     * {@inheritDoc} If you call this method with plain Terms instead of
     * ComparableTerms, it may not match any of the triples in the ontology as
     * they are all stored as ComparableTerms. So, use ComparableTerm objects!
     * The set returned is a set of ComparableTriple objects.
     *
     * @see ComparableTerm
    ...
    public Set getTriples(Term subject, Term object, Term predicate) {
        ...
        for (Iterator i = this.triples.iterator(); i.hasNext();) {
            ...
            if ((subject == null || ct.getSubject().equals(subject))
                    ...
                    && (predicate == null || ct.getPredicate().equals(predicate))) {
                results.add(ct);
            }
        }
        return results;
    ...
    /**
     * {@inheritDoc} This will always return a set of ComparableTerm objects. It
     * is not the original set so you are safe to modify it.
     *
     * @see ComparableTerm
     */
    public Set getTerms() {
    ...
    public boolean containsTriple(Term subject, Term object, Term predicate) {
        for (Iterator i = this.triples.iterator(); i.hasNext();) {
            ...
            if (ct.getSubject().equals(subject)
                    ...
                    && ct.getPredicate().equals(predicate)) {
                return true;
            }
        }
        return false;
