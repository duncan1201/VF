 ...
 * @since 1.5
 */
public class FlexSimpleComparableTerm extends AbstractChangeable implements ComparableTerm {
     ...
     */
    public FlexSimpleComparableTerm(ComparableOntology ontology, String name, Object[] synonyms) {
    ...
    protected FlexSimpleComparableTerm() {
    }
    ...
    /**
     * {@inheritDoc} Two terms are equal if they are in the same ontology and
     * share the same name.
     */
    ...
    /**
     * {@inheritDoc} Terms are sorted by ontology first, then name.
     */
    ...
    /**
     * {@inheritDoc} Synonyms are stored in the database as the results of a
     * toString() operation on each synonym object. This doesn't happen until it
     * reaches the database though, so if you are not using a database, don't
     * worry about it.
     */
    ...
    // Hibernate requirement - not for public use.
    void setSynonymSet(Set synonyms) {
    ...
    /**
     * {@inheritDoc} Form: "ontology:name [obsolete]" where [obsolete] is
     * optional
     */
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS AN EMPTY ANNOTATION OBJECT
     */
