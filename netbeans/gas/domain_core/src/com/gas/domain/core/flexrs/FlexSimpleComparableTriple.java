 ...
 * @since 1.5
 */
public class FlexSimpleComparableTriple extends AbstractChangeable implements ComparableTriple {
     ...
     */
    public FlexSimpleComparableTriple(ComparableOntology ontology, ComparableTerm subject, ComparableTerm object, ComparableTerm predicate) {
        if (ontology == null) {
    ...
    protected FlexSimpleComparableTriple() {
    }

    /**
     * {@inheritDoc} Triples are sorted in order of ontology, subject, object,
     * and finally predicate.
     */
    ...
    /**
     * {@inheritDoc} Triples are equal only if they are from the same ontology
     * and share the same subject, object and predicate.
     */
    ...
    /**
     * {@inheritDoc} Returns the output of toSring()
     */
    ...
    // Hibernate requirement - not for public use.
    void setSubject(ComparableTerm subject) {
        this.subject = subject;
    }
    ...
    // Hibernate requirement - not for public use.
    void setObject(ComparableTerm object) {
        this.object = object;
    }
    ...
    // Hibernate requirement - not for public use.
    void setPredicate(ComparableTerm predicate) {
        this.predicate = predicate;
    }
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS AN EMPTY LIST
     */
    ...
    // Hibernate requirement - not for public use.
    void setOntology(ComparableOntology ontology) {
        this.ontology = ontology;
    }

    /**
     * {@inheritDoc} ALWAYS RETURNS THE EMPTY STRING
     */
    ...
    /**
     * {@inheritDoc} does not do anything
     */
    public void setDescription(String desc) {
    }

    /**
     * {@inheritDoc} ALWAYS RETURNS THE EMPTY ANNOTATION
     */
    ...
    /**
     * {@inheritDoc} Form: "ontology:predicate(subject,object)"
     */
