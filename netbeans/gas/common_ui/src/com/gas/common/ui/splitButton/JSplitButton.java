package com.gas.common.ui.splitButton;

import com.gas.common.ui.splitButton.action.SplitButtonActionListener;
import java.awt.*;
...
public class JSplitButton extends JButton implements MouseMotionListener, MouseListener, ActionListener, Serializable {
    ...
    /**
     * Adds an
     * <code>SplitButtonActionListener</code> to the button.
     *
    ...
    /**
     * Removes an
     * <code>SplitButtonActionListener</code> from the button. If the listener
     * is the currently set
     * <code>Action</code> for the button, then the
     * <code>Action</code> is set to
     * <code>null</code>.
     *
