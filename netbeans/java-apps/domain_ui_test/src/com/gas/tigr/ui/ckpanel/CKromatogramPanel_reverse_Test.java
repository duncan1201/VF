 ...
 * @author dq
 */
public class CKromatogramPanel_reverse_Test extends JFrame {

    private CKromatogramPanel kPanel;

    public CKromatogramPanel_reverse_Test() {
    ...
    private Kromatogram getKromatogram() {
        ...
        ret = ret.reverseComplement();
        return ret;
    }

    public static void main(String[] args) {
        CKromatogramPanel_reverse_Test test = new CKromatogramPanel_reverse_Test();
