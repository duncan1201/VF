 ...
 * @author dq
 */
public class CKromatogramPanel_trim_start_Test extends JFrame {

    private CKromatogramPanel kPanel;

    public CKromatogramPanel_trim_start_Test() {
        super(CKromatogramPanel_trim_start_Test.class.getSimpleName());    
    ...
    public static void main(String[] args) {
        CKromatogramPanel_trim_start_Test test = new CKromatogramPanel_trim_start_Test();
