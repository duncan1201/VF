 ...
 * @author dq
 */
public class KromatogramPanel_reversed_Test extends JFrame {

    KromatogramPanel kPanel;
    public KromatogramPanel_reversed_Test() {
    ...
    public static void main(String[] args) {
        KromatogramPanel_reversed_Test test = new KromatogramPanel_reversed_Test();
