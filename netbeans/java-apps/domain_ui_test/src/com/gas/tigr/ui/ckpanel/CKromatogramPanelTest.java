 ...
 * @author dq
 */
public class CKromatogramPanelTest extends JFrame {

    private CKromatogramPanel kPanel;

    public CKromatogramPanelTest() {
        super(CKromatogramPanelTest.class.getSimpleName());        
    ...
    public static void main(String[] args) {
        CKromatogramPanelTest test = new CKromatogramPanelTest();
